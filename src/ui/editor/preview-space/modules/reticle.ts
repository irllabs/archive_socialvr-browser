...
export class Reticle {
  ...
  init(camera: THREE.PerspectiveCamera, vrCamera: THREE.PerspectiveCamera) {
    ...
    const reticleRingMaterial = new THREE.MeshBasicMaterial({color: 0xFFFFFF, opacity: 0.5, transparent: true, side: THREE.FrontSide});
    ...
    const reticleBackgroundMaterial = new THREE.MeshBasicMaterial({color: 0x000000, opacity: 0.5, transparent: true, side: THREE.FrontSide});
