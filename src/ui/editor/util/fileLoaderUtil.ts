...
import {
  MIME_TYPE_MP3, MIME_TYPE_WAV, MIME_TYPE_MPEG, MIME_TYPE_XWAV, MIME_TYPE_AAC, MIME_TYPE_XM4A,
  MIME_TYPE_PNG, MIME_TYPE_JPG, MIME_TYPE_JPEG,
  MIME_TYPE_ZIP, MIME_TYPE_X_ZIP, MIME_TYPE_OCTET_STREAM, MIME_TYPE_X_ZIP_COMPRESSED,
  MIME_TYPE_MP4
